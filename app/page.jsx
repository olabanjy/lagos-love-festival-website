...
import logoCQA1s3xX from "@asset/ScriptDesk.svg";
    ...
    <div className="select-none">
      <div className="fixed z-50 px-3 py-2 sm:py-5 w-screen bg-white backdrop-blur-xl bg-opacity-5">
        <div className="bg-gray-50 bg-opacity-70 items-center flex rounded-lg max-w-3xl py-3 px-4 sm:pr-8 z-50 mx-auto">
          ...
          >
            <div className="sm:flex space-y-4 sm:space-y-0 w-full rounded-xl p-4 sm:p-0 shadow-2xl sm:shadow-none bg-white sm:bg-transparent items-center">
              <div className="flex-grow sm:flex justify-center">
                <div onClick={() => updateSideNav(false)} className="px-4 py-2">
              ...
              <div
                onClick={() => updateSideNav(false)}
                className="text-lg sm:hidden text-center py-3 hover:bg-gray-50 rounded-xl cursor-pointer"
              >
                Close
              </div>
            </div>
          ...
          <div className="flex-grow flex justify-end sm:hidden">
            <div
              onClick={() => updateSideNav(true)}
              className=" w-8 h-8 bg-white rounded-md cursor-pointer flex items-center justify-center"
            >
              <CiMenuFries />
            </div>
          </div>
            ...
            <div className="space-y-8 pt-40 pb-12 sm:pt-32 sm:pb-32">
              <div className="space-y-4">
                <div className="text-2xl sm:text-4xl lg:text-7xl text-center">
                  ...
                  <div className="">
                    <span className="serious">Love</span> Carnival 2024
                  </div>
                </div>
                <div className="max-w-3xl mx-auto text-center text-xs sm:text-base lg:text-lg">
                  Brought to You by Very Single Lagosians & Eko Hotel in
                  Partnership With Hakuna Matata, endorsed by Lagos State
                ...
                >
                  <div className="btn hover:scale-110 hover:shadow-lg transition-all duration-500">
                    <div className="flex bg-white px-9 p-3 rounded-xl gap-2 items-center justify-center">
                      <div className="">
                        <Image draggable={false} src={icon} alt="" />
                      </div>
                      <div className="font-semibold">
                        Get your tickets today
                      </div>
      ...
      <div className="max-w-7xl overflow-hidden grid items-start xl:grid-cols-3 py-12 mx-auto px-5 space-y-6 lg:space-y-12">
        <div className="space-y-6 z-40 md:space-y-24 md:space-x-3 grid md:grid-cols-2 xl:grid-cols-1 relative xl:top-16">
          <div
            data-aos="fade-left"
            className="xl:w-[276px] overflow-hidden w-full relative rounded-3xl mx-auto h-[350px] gallery7"
          >
            <div className="p-3 py-6 space-y-2 bg-white rounded-3xl w-full">
              <div className="font-semibold sm:text-xl">Speed Dating</div>
              <div className="text-xs">
                Spark new connections in our fun, relaxed speed dating sessions
                designed to bring singles together.
              </div>
            </div>
          ...
          <div
            data-aos="fade-left"
            className="xl:w-[376px] overflow-hidden w-full relative xl:left-12 rounded-3xl mx-auto h-[200px] gallery8"
          >
            <div className="p-3 py-6 space-y-2 bg-white rounded-3xl w-full">
              <div className="font-semibold sm:text-xl">
                Waterparks and Palmwine Spots
              </div>
              <div className="text-xs">
        ...
        <div className="flex flex-col items-center md:flex-row xl:flex-col xl:items-end justify-center lg:gap-6">
          <div
            data-aos="fade-up"
            className="h-[200px] overflow-hidden w-full xl:w-[300px] rounded-3xl gallery9"
          >
            <div className="p-3 py-6 space-y-2 bg-white rounded-3xl w-full">
              <div className="font-semibold sm:text-xl">
              ...
              <div className="text-xs">
                Groove to the beats of top DJs, live bands, and surprise musical
                performances that will keep you dancing all night.
              </div>
            </div>
          </div>
          ...
          <div
            data-aos="fade-down"
            className="h-[200px] overflow-hidden w-full xl:w-[440px] rounded-3xl mt-14 gallery10"
          >
            <div className="p-3 py-6 space-y-2 bg-white rounded-3xl w-full">
              <div className="font-semibold sm:text-xl">Cultural Showcase</div>
              <div className="text-xs">
                Traditional dances, fashion shows, and art exhibitions
                representing various Nigerian tribes.
              </div>
            </div>
          </div>
        </div>
        <div className="space-y-6 z-40 md:space-y-24 md:space-x-3 grid md:grid-cols-2 xl:grid-cols-1 relative xl:-top-16">
          <div
            data-aos="fade-right"
            className="xl:w-[276px] overflow-hidden relative rounded-3xl xl:ml-auto h-[350px] gallery11"
          >
            <div className="p-3 py-6 space-y-2 bg-white rounded-3xl w-full">
              <div className="font-semibold sm:text-xl">
              ...
              <div className="text-xs">
                Dive into interactive games, obstacle courses, waterparks, and
                palm wine spots that promise endless fun and excitement.
              </div>
            </div>
          </div>
          <div
            data-aos="fade-right"
            className="xl:w-[276px] overflow-hidden relative rounded-3xl xl:mx-auto h-[350px] gallery12"
          >
            <div className="p-3 py-6 space-y-2 bg-white rounded-3xl w-full">
              <div className="font-semibold sm:text-xl">
              ...
              <div className="text-xs">
                Offering diverse Nigerian cuisine and drinks from different
                regions.
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="rounded-lg overflow-hidden bgImg1">
            <div className="bg-purple-700 space-y-1 h-full text-white bg-opacity-70 p-6 md:p-12">
              ...
              <div className="md:text-xl text-xs font-normal pr-8">
                Join engaging workshops and discussions for singles and couples,
                covering topics like relationships and personal growth.
              </div>
            </div>
          </div>
          <div className="rounded-lg overflow-hidden bgImg2">
            <div className="bg-purple-700 space-y-1 text-white bg-opacity-70 p-6 md:p-12">
              ...
              <div className="md:text-xl text-xs font-normal pr-8">
                Witness the exclusive premiere of our video documentary
                highlighting the rich culture, diverse restaurants, and vibrant
                lifestyle of Lagos, showing how love can blossom in this unique
                city.
              </div>
            </div>
          </div>
      ...
      <div id="about" className="relative rounded-2xl overflow-hidden">
        ...
        <div className="bg-white rounded-2xl backdrop-blur-2xl bg-opacity-20 relative z-10">
          <div className="max-w-5xl space-y-6 lg:space-y-12 px-5 sm:px-12 py-24 lg:leading-[40px] font-semibold text-lg sm:text-xl lg:text-3xl mx-auto">
            <p>
              Tired of the endless dating games and{" "}
              <span className="heartBreak">heartbreak</span>?
            </p>
            <p>
              Join us for the Lagos Love Carnival from{" "}
              <span className="date">December 18th to 20th,</span>{" "}
              <span className="serious">2024</span> at{" "}
              <span className="location">Hakuna Matata theme Park!</span>{" "}
              Celebrate love, culture, and unity with singles and couples at
              this unforgettable event.
            </p>
            <p>
              Under the theme &ldquo;Unity Across Tribes,&rdquo; this vibrant
              festival showcases Lagos&apos; diversity. Don&apos;t miss the fun,
              activities, food, and connections at this year&apos;s{" "}
              <span className="event">Lagos Love Carnival!</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl space-y-8 pt-12 mx-auto p-4">
        <div className="sm:flex space-y-5 sm:space-y-0 items-center">
          <div className="text-3xl flex-grow font-semibold">
            ...
            <div className="">
              Media <span className="event">Partners</span>
            </div>
          </div>
          <div className="flex">
          ...
          <div className="space-y-8 py-12 lg:py-32 z-10 px-4 lg:px-16 xl:px-24">
            <div className="space-y-2 text-white">
              ...
              <div className="lg:max-w-[400px] md:text-xl font-thin xl:max-w-[479px]">
                ...
                far. You&apos;re about to have the best online dating experience
                on the <strong>Pair app—</strong> all you need are some good
                pics and a solid bio to stand out.
              </div>
            </div>
            <div className="flex">
              <a
                ...
                <div className="btn hover:scale-110 hover:shadow-lg transition-all duration-500">
                  <div className="flex bg-white px-9 p-3 rounded-xl gap-2 items-center justify-center">
                    ...
                    <div className="">
                      <Image draggable={false} src={arrow} alt="" />
                    </div>
                  </div>
                </div>
              </a>
      ...
      <div id="testimony">
        <div className="space-y-4 py-10">
          <div className="max-w-7xl mx-auto p-4 font-bold text-lg sm:text-3xl">
            Testimonials from Past Events
          </div>
          <div className="max-w-[96%] ml-auto">
            <Marquee pauseOnHover speed={35}>
              {testimony.map((data, i) => (
                <TestimonyCard data={data} key={i} />
              ))}
            </Marquee>
          </div>
        </div>
      ...
      <div className="max-w-7xl space-y-16 sm:space-y-28 mx-auto py-12 px-3">
        <div className="relative space-y-6 max-w-6xl mx-auto bg-[#492F92] p-6 sm:p-12 rounded-2xl text-white ">
          ...
          <div className="space-y-1">
            ...
            <div className="lg:max-w-[400px] xl:max-w-[481px]">
              Lagos Love Carnival offers unique partnership and sponsorship
              opportunities to showcase your brand to thousands of attendees.
              From media placements to exclusive event activations, get involved
              and connect with our diverse audience
            </div>
          </div>
            ...
            <div className="">
              ...
              <span className="relative">
                ...
                <Image
                  ...
                  src={underline}
                  alt=""
                  className="absolute w-11/12 h-4 right-0"
                />
              </span>
            </div>
          </div>
        ...
        <div className="text-xs space-y-4 lg:space-y-0 lg:flex items-center gap-5 p-3 sm:p-6  rounded-xl lg:rounded-full border border-gray-200">
          <div className="flex-grow">
            &copy; {year} Lagos Love Carnival. All rights reserved
          </div>
          <div className="space-y-4 lg:space-y-0 lg:flex items-center gap-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2 items-center">
                <div className="w-7 h-7 text-white bg-black rounded-full flex items-center justify-center">
                  <FaFacebook />
                </div>
                <div className="w-7 h-7 text-white bg-black rounded-full flex items-center justify-center">
                  <FaTwitter />
